...
#include </home/yc/catkin_ws/devel/include/camera_lidar_sample_data/Sampledata.h>
#include </home/yc/catkin_ws/devel/include/unicore/RawImu.h>
#include </home/yc/catkin_ws/src/unicore/include/unicore/msg_buffer.hpp>
...
int main(int argc, char **argv)
{
  ...
  sampledata_pub  = n.advertise<camera_lidar_sample_data::Sampledata>("/camera_and_lidar", 5);
   ...
   message_filters::Subscriber<sensor_msgs::Image> leftimg_sub(n,"/mynteye/left/image_raw", 50);//原始图像topic = /mynteye/left/image_raw
   message_filters::Subscriber<sensor_msgs::Image> rightimg_sub(n,"/mynteye/right/image_raw", 50);//原始图像 topic = /mynteye/right/image_raw
